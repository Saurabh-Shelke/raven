 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qn{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(zn(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function zn(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ue="@firebase/app",xe="0.9.29";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tr=1024,Rr=30*24*60*60*1e3;class Ar{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new Dr(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}triggerHeartbeat(){return c(this,null,function*(){var e,n;const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=Ue();if(!(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=yield this._heartbeatsCachePromise,((n=this._heartbeatsCache)===null||n===void 0?void 0:n.heartbeats)==null))&&!(this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(a=>a.date===i)))return this._heartbeatsCache.heartbeats.push({date:i,agent:s}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(a=>{const o=new Date(a.date).valueOf();return Date.now()-o<=Rr}),this._storage.overwrite(this._heartbeatsCache)})}getHeartbeatsHeader(){return c(this,null,function*(){var e;if(this._heartbeatsCache===null&&(yield this._heartbeatsCachePromise),((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=Ue(),{heartbeatsToSend:r,unsentEntries:s}=kr(this._heartbeatsCache.heartbeats),i=Je(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=n,s.length>0?(this._heartbeatsCache.heartbeats=s,yield this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i})}}function Ue(){return new Date().toISOString().substring(0,10)}function kr(t,e=Tr){const n=[];let r=t.slice();for(const s of t){const i=n.find(a=>a.agent===s.agent);if(i){if(i.dates.push(s.date),Fe(n)>e){i.dates.pop();break}}else if(n.push({agent:s.agent,dates:[s.date]}),Fe(n)>e){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class Dr{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}runIndexedDBEnvironmentCheck(){return c(this,null,function*(){return Xe()?Qe().then(()=>!0).catch(()=>!1):!1})}read(){return c(this,null,function*(){if(yield this._canUseIndexedDBPromise){const n=yield Sr(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}})}overwrite(e){return c(this,null,function*(){var n;if(yield this._canUseIndexedDBPromise){const s=yield this.read();return $e(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return})}add(e){return c(this,null,function*(){var n;if(yield this._canUseIndexedDBPromise){const s=yield this.read();return $e(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return})}}function Fe(t){return Je(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Or(t){O(new S("platform-logger",e=>new qn(e),"PRIVATE")),O(new S("heartbeat",e=>new Ar(e),"PRIVATE")),D(ue,xe,t),D(ue,xe,"esm2017"),D("fire-js","")}Or("");var Nr="firebase",Mr="10.9.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ut({projectId:t}){return`${Lr}/projects/${t}/installations`}function ht(t){return{token:t.token,requestStatus:2,expiresIn:Fr(t.expiresIn),creationTime:Date.now()}}function ft(t,e){return c(this,null,function*(){const r=(yield e.json()).error;return R.create("request-failed",{requestName:t,serverCode:r.code,serverMessage:r.message,serverStatus:r.status})})}function dt({apiKey:t}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function Ur(t,{refreshToken:e}){const n=dt(t);return n.append("Authorization",jr(e)),n}function pt(t){return c(this,null,function*(){const e=yield t();return e.status>=500&&e.status<600?t():e})}function Fr(t){return Number(t.replace("s","000"))}function jr(t){return`${ct} ${t}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yr="firebase-installations-database",Xr=1,A="firebase-installations-store";let ne=null;function we(){return ne||(ne=q(Yr,Xr,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(A)}}})),ne}function j(t,e){return c(this,null,function*(){const n=z(t),s=(yield we()).transaction(A,"readwrite"),i=s.objectStore(A),a=yield i.get(n);return yield i.put(e,n),yield s.done,(!a||a.fid!==e.fid)&&bt(t,e.fid),e})}function yt(t){return c(this,null,function*(){const e=z(t),r=(yield we()).transaction(A,"readwrite");yield r.objectStore(A).delete(e),yield r.done})}function G(t,e){return c(this,null,function*(){const n=z(t),s=(yield we()).transaction(A,"readwrite"),i=s.objectStore(A),a=yield i.get(n),o=e(a);return o===void 0?yield i.delete(n):yield i.put(o,n),yield s.done,o&&(!a||a.fid!==o.fid)&&bt(t,o.fid),o})}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rs(r,s){return c(this,arguments,function*({appConfig:t,heartbeatServiceProvider:e},n){const i=ss(t,n),a=Ur(t,n),o=e.getImmediate({optional:!0});if(o){const f=yield o.getHeartbeatsHeader();f&&a.append("x-firebase-client",f)}const l={installation:{sdkVersion:ot,appId:t.appId}},h={method:"POST",headers:a,body:JSON.stringify(l)},u=yield pt(()=>fetch(i,h));if(u.ok){const f=yield u.json();return ht(f)}else throw yield ft("Generate Auth Token",u)})}function ss(t,{fid:e}){return`${ut(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rs="firebase-messaging-database",As=1,k="firebase-messaging-store";let ie=null;function Ie(){return ie||(ie=q(Rs,As,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(k)}}})),ie}function Ee(t){return c(this,null,function*(){const e=ve(t),r=yield(yield Ie()).transaction(k).objectStore(k).get(e);if(r)return r;{const s=yield Ss(t.appConfig.senderId);if(s)return yield Ce(t,s),s}})}function Ce(t,e){return c(this,null,function*(){const n=ve(t),s=(yield Ie()).transaction(k,"readwrite");return yield s.objectStore(k).put(e,n),yield s.done,e})}function ks(t){return c(this,null,function*(){const e=ve(t),r=(yield Ie()).transaction(k,"readwrite");yield r.objectStore(k).delete(e),yield r.done})}function ve({appConfig:t}){return t.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */oi();fn([{"revision":null,"url":"assets/AddCustomEmojiDialog-15ed8490.js"},{"revision":null,"url":"assets/AddMembersDropdown-88e80609.js"},{"revision":null,"url":"assets/AddRavenUsersPage-83daeef5.js"},{"revision":null,"url":"assets/AddWorkspaceMemberModalContent-ffe0f7d4.js"},{"revision":null,"url":"assets/AINotEnabledCallout-6cdcef2f.js"},{"revision":null,"url":"assets/Appearance-702fcf3a.js"},{"revision":null,"url":"assets/AuthContainer-6f4c35bc.js"},{"revision":null,"url":"assets/BotForm-744234b1.js"},{"revision":null,"url":"assets/BotList-a4473fe2.js"},{"revision":null,"url":"assets/ChatSpace-c378246e.js"},{"revision":null,"url":"assets/CodeBlock-5fc83e57.js"},{"revision":null,"url":"assets/CreateBot-74d3840c.js"},{"revision":null,"url":"assets/CreateDocumentNotification-e06dfda0.js"},{"revision":null,"url":"assets/CreateFunction-5b9373c5.js"},{"revision":null,"url":"assets/CreateInstructionTemplate-f8df0f37.js"},{"revision":null,"url":"assets/CreateMessageAction-48aaf663.js"},{"revision":null,"url":"assets/CreatePoll-aa138c49.js"},{"revision":null,"url":"assets/CreateSavedPrompt-739ec3d3.js"},{"revision":null,"url":"assets/CreateSchedulerEvent-90cf5165.js"},{"revision":null,"url":"assets/CreateWebhook-12310a9b.js"},{"revision":null,"url":"assets/CustomEmojiList-f24357b6.js"},{"revision":null,"url":"assets/DateSeparator-55fa17c4.js"},{"revision":null,"url":"assets/DeleteAlert-72df79c6.js"},{"revision":null,"url":"assets/DoctypeLinkRenderer-5c845fcf.js"},{"revision":null,"url":"assets/DoctypeVariableDialogForm-2f0c0daa.js"},{"revision":null,"url
},{"revision":null,"url":"assets/ThreadDrawer-abef18a3.js"},{"revision":null,"url":"assets/Threads-93cadb49.js"},{"revision":null,"url":"assets/tiptap-8b80dc76.css"},{"revision":null,"url":"assets/TypingIndicator-a31fce65.js"},{"revision":null,"url":"assets/UploadImageModal-375ec61c.js"},{"revision":null,"url":"assets/useCurrentChannelData-5d20df6c.js"},{"revision":null,"url":"assets/useCurrentChannelData-b08321ce.css"},{"revision":null,"url":"assets/useDebounce-02f398f3.js"},{"revision":null,"url":"assets/useDoctypeMeta-749cfb81.js"},{"revision":null,"url":"assets/useGetUserRecords-beb6efeb.js"},{"revision":null,"url":"assets/useRavenSettings-a6b6461e.js"},{"revision":null,"url":"assets/UserList-d3e84b4d.js"},{"revision":null,"url":"assets/UserProfile-7f121835.js"},{"revision":null,"url":"assets/useThreadPageActive-5236f6c8.js"},{"revision":null,"url":"assets/validations-18aa1769.js"},{"revision":null,"url":"assets/ViewBot-efb3d712.js"},{"revision":null,"url":"assets/ViewDocumentNotification-4eff733c.js"},{"revision":null,"url":"assets/ViewFilesContent-dd4ad41a.js"},{"revision":null,"url":"assets/ViewFunction-0e5567cd.js"},{"revision":null,"url":"assets/ViewInstructionTemplate-856b9311.js"},{"revision":null,"url":"assets/ViewMessageAction-1eabf08e.js"},{"revision":null,"url":"assets/ViewSavedPrompt-c9f79a1c.js"},{"revision":null,"url":"assets/ViewSchedulerEvent-43ce3138.js"},{"revision":null,"url":"assets/ViewThread-afc3793b.js"},{"revision":null,"url":"assets/ViewWebhook-52050729.js"},{"revision":null,"url":"assets/ViewWorkspace-249d7091.js"},{"revision":null,"url":"assets/WebhookForm-4cfc7c6d.js"},{"revision":null,"url":"assets/WebhookList-4effb2e4.js"},{"revision":null,"url":"assets/WorkspaceList-c31ea5d8.js"},{"revision":null,"url":"assets/WorkspaceMemberManagement-60867905.js"},{"revision":"a474e4aebd7d9c3b5da85e8f5c95af49","url":"frappe-push-notification.js"},{"revision":"1a3714d138a2aeb79bc189f0915f2586","url":"index.html"},{"revision":"3473d7d7f90ba34e10c58ee8e57760fa","url":"manifest.webmanifest"}]);un();const fi=new URL(location).searchParams.get("config");try{let n=function(){return navigator.userAgent.toLowerCase().includes("chrome")};const t=nt(JSON.parse(fi)),e=ui(t);hi(e,r=>{const s=r.data.title;let i={body:r.data.body||""};r.data.notification_icon&&(i.icon=r.data.notification_icon),r.data.raven_message_type==="Image"&&(i.image=r.data.content),r.data.creation&&(i.timestamp=r.data.creation);const a=`${r.data.base_url}/raven/channel/${r.data.channel_id}`;n()?i.data={url:a}:i.actions=[{action:a,title:"View"}],self.registration.showNotification(s,i)}),n()&&self.addEventListener("notificationclick",r=>{r.stopImmediatePropagation(),r.notification.close(),r.notification.data&&r.notification.data.url&&clients.openWindow(r.notification.data.url)})}catch(t){console.log("Failed to initialize Firebase",t)}self.skipWaiting();dn();console.log("Service Worker Initialized");
